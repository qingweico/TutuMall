$(function () {
    // 获取此店铺下的商品列表的URL
    let listUrl = '/shopadmin/getproductlistbyshop?pageIndex=1&pageSize=999';
    // 商品下架URL
    let statusUrl = '/shopadmin/addormodifyproduct';
    getList();
        ...
        .on('click',
            ...
            function (e) {
                ...
                if (target.hasClass('edit')) {
                    ...
                    window.location.href = '/shopadmin/productdetail?productId='
                        + e.currentTarget.dataset.id;
                }
            });
