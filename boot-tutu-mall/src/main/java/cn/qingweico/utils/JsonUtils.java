...
public class JsonUtils {
    ...
    public static ArrayList<?> jsonArrayToArrayList(String jsonArray) {
        ...
        Gson gson = new GsonBuilder().excludeFieldsWithModifiers(Modifier.FINAL, Modifier.TRANSIENT, Modifier.STATIC).setDateFormat("yyyy-MM-dd HH:mm:ss").serializeNulls().create();
        ArrayList<?> list = null;
        try {
